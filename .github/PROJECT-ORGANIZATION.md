...
<!-- Placeholders: 46-accelerator = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 46-accelerator - Organization Standards
